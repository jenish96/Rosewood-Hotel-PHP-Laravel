...
@section('main')
    <div class="row" style="background-color: rgb(206, 29, 29); padding:20px;">
        <h2 style="text-align: center; color:white;">My Account</h2>
    </div>
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <h6 class="text-muted f-w-400">{{ $userData->username }}</h6>
                                        </div>
                                        <div class="col-sm-6">
                                            <p class="m-b-20 p-b-5 b-b-default f-w-600">Phone</p>
                                            <h6 class="text-muted f-w-400">{{ $userData->contact_no }}</h6>
                                        </div>
                                    </div><br>
                                    ...
                                    <br> <br> <br>
                                    <a href="/user/editAccount" title="View Booking Details" class="theme-btn btn-sm">Edit<i
