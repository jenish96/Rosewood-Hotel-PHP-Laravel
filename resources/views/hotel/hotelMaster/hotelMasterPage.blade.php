	...
	<div class="page-wrapper">
			...
			<div class="page-header-inner ">
				...
				<div class="page-logo">
					<a href="index.html">
						...
						<span class="logo-default">Hotel</span> </a>
				</div>
				<!-- logo end -->
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-user">
							<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
								...
								<span class="username username-hide-on-mobile">{{Session::get('hotel_name')}}</span>
					...
					<div id="remove-scroll">
						<ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true"
							...
							<li class="sidebar-user-panel">
								<div class="user-panel">
									...
									<div class="sidebar-userpic-btn">
										<a class="tooltips" href="/hotel/viewAccount" data-placement="top"
										...
										<a class="tooltips" href="/hotellogout" data-placement="top"
							...
							<li class="nav-item start active">
								<a href="/hotel/hotelDashboard" class="nav-link nav-toggle">
							...
							<li class="nav-item">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="/hotel/viewRoom" class="nav-link ">
											<span class="title">All Rooms</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="/hotel/viewMedia" class="nav-link ">
											<span class="title">Media</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="/hotel/viewAmenities" class="nav-link ">
							...
							<li class="nav-item">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="/hotel/viewBooking" class="nav-link ">
											<span class="title">All Booking</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="/hotel/viewRoomBooking" class="nav-link ">
											<span class="title">Room Booking</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="/hotel/viewStatus" class="nav-link ">
											<span class="title">Booking Status</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="/hotel/viewBookingMember" class="nav-link ">
							...
							<li class="nav-item">
								<a href="/hotel/viewOffer" class="nav-link nav-toggle">
									<i class="material-icons">vpn_key</i>
									<span class="title">Offers</span>
								</a>
							</li>
							<li class="nav-item">
								<a href="/hotel/viewReview" class="nav-link nav-toggle">
							...
							<li class="nav-item">
								<a href="/hotel/viewAccount" class="nav-link nav-toggle">
                                    <i class="material-icons f-left">person</i>
									<span class="title">My Acount</span>
							...
							<div class="chat-sidebar-list">
								<div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd"
									...
									<ul class="media-list list-items">
										<li class="media"><img class="media-object" src="{{ URL::to('/')}}/assets/img/user/user3.jpg"
										...
										<li class="media">
											...
											</div> <img class="media-object" src="{{ URL::to('/')}}/assets/img/user/user1.jpg" width="35"
												height="35" alt="...">
											<i class="busy dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="{{ URL::to('/')}}/assets/img/user/user5.jpg"
												width="35" height="35" alt="...">
											<i class="away dot"></i>
											<div class="media-body">
										...
										<li class="media">
											...
											</div> <img class="media-object" src="{{ URL::to('/')}}/assets/img/user/user4.jpg" width="35"
												height="35" alt="...">
											<i class="online dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="{{ URL::to('/')}}/assets/img/user/user2.jpg"
												width="35" height="35" alt="...">
											<i class="busy dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="{{ URL::to('/')}}/assets/img/user/user7.jpg"
												width="35" height="35" alt="...">
											<i class="online dot"></i>
											<div class="media-body">
									...
									<ul class="media-list list-items">
										<li class="media">
											...
											</div> <img class="media-object" src="{{ URL::to('/')}}/assets/img/user/user6.jpg" width="35"
												height="35" alt="...">
										...
										<li class="media"><img class="media-object" src="{{ URL::to('/')}}/assets/img/user/user8.jpg"
												width="35" height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
										...
										<li class="media">
											...
											</div> <img class="media-object" src="{{ URL::to('/')}}/assets/img/user/user9.jpg" width="35"
												height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
										...
										<li class="media"><img class="media-object" src="{{ URL::to('/')}}/assets/img/user/user10.jpg"
												width="35" height="35" alt="...">
											<i class="offline dot"></i>
											<div class="media-body">
		...
		<div class="page-footer">
			<div class="page-footer-inner"> 2022 &copy; All Rights Reserved By 
				<a href="#" target="_top" class="makerCss">{{Session::get('hotel_name')}}</a>
			</div>
