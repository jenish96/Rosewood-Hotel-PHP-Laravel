                ...
                <div class="col-xl-10 col-md-12">
                    <div class="card user-card-full">
                        <div class="row m-l- m-r-0">
                            ...
                            <div class="col-sm-12">
                                <form action="/admin/updateProfile" id="form1" method="post">
                                    @csrf
                                    <div class="card-block">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <h6 class="text-muted f-w-400">
                                                    <input type="text" class="form-control"
                                                        value="{{ $adminData->username }} " name="txtUsername">
                                                </h6>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <h6 class="text-muted f-w-400">
                                                    <input type="text" class="form-control"
                                                        value="{{ $adminData->name }}" name="txtName">
                                                </h6>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <h6 class="text-muted f-w-400">
                                                    <input type="text" class="form-control"
                                                        value="{{ $adminData->contact_no }}" name="txtphone">
                                                </h6>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <h6 class="text-muted f-w-400">
                                                    <input type="text" class="form-control"
                                                        value="{{ $adminData->email }}" name="txtemail">
                                                </h6>
                                                </h6>
                                            </div>
