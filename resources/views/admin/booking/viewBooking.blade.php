    ...
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            ...
            <ol class="breadcrumb page-breadcrumb pull-right">
                ...
                <li><a class="parent-item" href="/admin/viewBooking">Booking</a>&nbsp;<i class="fa fa-angle-right"></i>
                </li>
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/admin/viewmoreBooking/{{$row->booking_id}}" type="button" class="btn btn-round btn-primary">View</a>
                                    </td>
