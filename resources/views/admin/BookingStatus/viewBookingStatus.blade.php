...
<div class="page-content">
    <div class="page-bar">
        <div class="page-title-breadcrumb">
            <div class=" pull-left">
                <div class="page-title">Booking - Status</div>
            </div>
            <ol class="breadcrumb page-breadcrumb pull-right">
                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="/admin/dashboard">Dashboard</a>&nbsp;<i class="fa fa-angle-right"></i>
                </li>
                <li><a class="parent-item" href="/admin/viewBookingStatus">Booking - Status</a>&nbsp;<i class="fa fa-angle-right"></i>
                </li>
        ...
        <div class="col-md-12">
            <div class="card card-topline-aqua">
                <div class="card-head">
                    ...
                    <header>View Booking - Status</header>
                    <div class="">
                    </div>
                    <div>
                    </div>
                        ...
                        <table id="example1" class="display full-width">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($row->status == "yes")
                                        <a href="/admin/isPay/no" type="button" class="label label-sm label-success">Booked</a>
                                        @else
                                        <a href="/admin/isPay/yes" type="button" class="label label-sm label-danger">UnBooked</a>
                                        @endif</td>  
