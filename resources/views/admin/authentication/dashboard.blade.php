            ...
            <div class="col-xl-3 col-md-6 col-12">
                <div class="info-box bg-orange">
                    ...
                    <div class="info-box-content">
                        ...
                        <!-- <span class="info-box-number">{{$total_hotel}}</span> -->
                        <div class="progress">
                            ...
                            <table class="table display product-overview mb-30" id="support_table5">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                         @if($row->is_pay == "yes")
                                        <a href="/admin/isPay/no" type="button" class="label label-sm label-success">paid</a>
                                        @else
                                        <a href="/admin/isPay/yes" type="button" class="label label-sm label-danger">Unpaid</a>
                                        @endif
                                        </td>
                        ...
                        <ul class="docListWindow small-slimscroll-style">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        <div class="prog-avatar">
                                            <img src="{{ URL::to('/')}}/assets/img/user/user1.jpg" alt="" width="40"
                                            height="40">
                                        </div>
                                        <div class="details">
                                            <div class="title">
                                                <a href="#">{{$row->username}}</a>
                                                <p class="rating-text">{{$row->review}}</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        <div class="prog-avatar">
                                            <img src="{{ URL::to('/')}}/assets/img/user/user3.jpg" alt="" width="40"
                                                height="40">
                                        </div>
                                        <div class="details">
                                            <div class="title">
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        <div class="prog-avatar">
                                            <img src="{{ URL::to('/')}}/assets/img/user/user4.jpg" alt="" width="40"
                                                height="40">
                                        </div>
                                        <div class="details">
                                            <div class="title">
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        <div class="prog-avatar">
                                            <img src="{{ URL::to('/')}}/assets/img/user/user5.jpg" alt="" width="40"
                                                height="40">
                                        </div>
                                        <div class="details">
                                            <div class="title">
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        <div class="prog-avatar">
                                            <img src="{{ URL::to('/')}}/assets/img/user/user6.jpg" alt="" width="40"
                                                height="40">
                                        </div>
                                        <div class="details">
                                            <div class="title">
