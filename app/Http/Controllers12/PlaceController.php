...
class PlaceController extends Controller
{
    ...
    public function viewmorePlace($id)
    {
        $placeData =Place::select("*")->where("place_id",$id)
        ->leftjoin("tbl_city", "tbl_place.city_id", "=", "tbl_city.city_id")->first();
        return view("admin.places.viewmorePlace",compact("placeData"));
    }
    ...
    public function insertPlace(Request $request)
    {
        ...
        $lat =$request -> txtlattitude;
        $long = $request -> txtlongitude;
