        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                {{-- <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li><a class="parent-item" href="/admin/changepwd">Change Password</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
            ...
            <div class="col-md-6 col-sm-6">
                ...
                @endif
                    <div class="card-body " id="bar-parent">
                        <form action="/admin/updatepwd" method="POST" id="form1">
                            @csrf
