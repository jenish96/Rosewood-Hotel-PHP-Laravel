...
@section('title')
{{Session::get('name')}} - View HotelAmenities
@endsection
    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">View HotelAmenities</div>
                </div>
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">View HotelAmenities</li>
                </ol>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card card-topline-green">
                            <div class="card-head">
                                ...
                                <a href="/admin/viewHotelAmenities"> <button type="button"
