            ...
            <div class="room-wrap">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="room-item">
                            <div class="room-img">
                                <img src="{{URL::to('/')}}/uploads/media/{{$row->photo_url}}" alt="">
                            </div>
                            <div class="room-content">
                                <h2><a href="/user/roomDetails/{{$row->room_id}}">{{$row->room_name}}</a></h2>
                                <ul>
                                    <li><i class="fi flaticon-expand-arrows"></i>{{$row->room_type}}</li>
                                    <li><i class="fi flaticon-bed"></i>{{$row->beds}} Beds</li>
                                    <li><i class="fi flaticon-bathtub"></i>{{$row->hotel_name}}</li>
                                </ul>
