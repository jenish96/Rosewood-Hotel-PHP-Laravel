        ...
        <div class="col-md-12">
            <div class="card card-topline-aqua">
                <div class="card-head">
                   ...
                   <a href="/admin/addState"> <button type="button" class="btn btn-round btn-primary float-right m-2">Add State</button></a>
                </div>
                        ...
                        <table id="example1" class="display full-width">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin/editState/{{$row->state_id}}" type="button" class="btn btn-round btn-success">Edit</a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <form action="/admin/deleteState" method="POST">
                @csrf
