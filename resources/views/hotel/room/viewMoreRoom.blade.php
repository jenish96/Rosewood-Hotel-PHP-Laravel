                        ...
                        <div class="card card-topline-green">
                            ...
                            <div class="card-body">
                                ...
                                <tr>
                                    <th>Status</th>
                                    <td>
                                        @if($roomData->status == "yes")
                                        <a href="#/no" type="button" class="btn btn-round btn-success btn-sm">Available</a>
                                        @else
                                        <a href="#/yes" type="button"  class="btn btn-round btn-danger btn-sm">Unavailable</a>
                                        @endif
