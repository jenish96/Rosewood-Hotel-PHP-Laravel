        ...
        <div class="col-md-12">
            <div class="card card-topline-aqua">
                <div class="card-head">
                   ...
                   <a href="/hotel/addMedia"> <button type="button" class="btn btn-round btn-primary float-right m-2">Add Media</button></a>
                </div>
                        ...
                        <table id="example1" class="display full-width">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row->room_name}}</td>
                                    <td>
                                        <a href="/hotel/editMedia/{{$row->media_id}}" type="button" class="btn btn-round btn-success">Edit</button></a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <form action="/hotel/deleteMidea" method="POST">
                @csrf
